    ...
    <div className='container-donation'>
      ...
      <div className='donation-row'>
        <div className='donation-eth'>
          ...
          {!provider ? (
            <button class='d-btn d-btn1 d-btn1-sep icon-connect' onClick={connectWallet}>Wallet Connect</button>
          ) : (
            <>
              ...
              />
              <button className='d-button' onClick={sendETH}>Invia donazione in ETH</button>
            </>
          )}
        </div>
        <div className='donation-paypal'>
          ...
          <form action="https://www.paypal.com/donate" method="post" target="_blank">
            ...
            <button class='d-btn d-btn1 d-btn1-sep icon-paypal' name="submit" title="PayPal - The safer, easier way to pay online!" alt="PayPal">PayPal</button>
          </form>
        </div>
      </div>
    </div>
